...
<?php wp_head(); ?>
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory') ?>/third-party/slick-1.5.9/slick/slick.css"/>
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_directory') ?>/third-party/slick-1.5.9/slick/slick-theme.css"/>
			...
			<?php if( tie_get_option( 'stick_nav' ) ) $stick = ' class="fixed-enabled"' ?>
				...
				<nav id="<?php echo $navID; ?>"<?php echo $stick; ?>>
					...
					<?php endif ?>
						...
						<a href="#" class="topBtn">Partner With Us</a>
				</nav><!-- .main-nav /-->
			<?php endif; ?>
		</div>
